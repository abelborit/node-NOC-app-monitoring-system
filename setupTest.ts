...
/* config para poder configurar las variables de entorno ya que sin estas configuración al momento de querer leer las variables de entorno estará leyendo las del .env y no las que colocamos para el test que están en .env.test */
config({
  path:".env.test"
})
